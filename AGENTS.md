...
| 4 | `parts/sinus/`       | Manifesto: dual-phase accusation→answer text on a "deFEEST" wallpaper, sine-wobble + colour cycle, white border flash on swap, LP filter close + drums silent under | `$F6 = $30` (frame counter hits 250) |
